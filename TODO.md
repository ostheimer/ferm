...
- Web-E2E-Strecke um weitere Kernmodule wie `Sitzungen`-Mutationen, Dokument-Download und Freigabe-Flow erweitern.
...
- Offline-Mutations-Queue fuer `Ansitz` und `Fallwild` um echte Formulare, Foto-Upload und feinere Konfliktbehandlung erweitern.
